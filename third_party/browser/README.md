...
- **Windows exception: agent-browser 0.36.0-omb.1** is an Dani Bot vendor
...
updated through reviewed Dani Bot releases, not a silent browser updater.

On macOS, release signing applies Dani Bot's Developer ID to native
...
imply endorsement of Dani Bot. This provenance record is not legal advice
