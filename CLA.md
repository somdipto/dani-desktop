# Dani Bot Contributor License Agreement

This agreement covers contributions to the `enterprise/` directory of the
Dani Bot repository, which is licensed under the Dani Bot Enterprise
...
1. **Copyright license.** You grant Dani ("the Project Owner") and
   ...
   under any license, including the Dani Bot Enterprise License and the
   Apache License 2.0.
