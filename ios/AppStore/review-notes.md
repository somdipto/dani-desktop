...
DaniMobile is a companion for the Dani Bot desktop application. The
...
1. Install and start Dani Bot on a Mac, Windows, or Linux computer.
...
6. In Safari, Notes, Photos, or Files, open the system Share sheet and choose
   **Dani Bot**. The extension shows the paired computer and asks for a bot
...
specific computer and receives no universal Dani Bot account credential.
The reviewer may use any email inbox they control. This optional path uses an
Dani Bot-managed Cloudflare Tunnel and does not require Tailscale.
