...
/// Pairing with a server directly (`danibot serve`, the Docker stack):
...
final class ServerPairingTests: XCTestCase {
    ...
    func testTheServersLinkBecomesAHostedInviteWithTheNormalizedCode() throws {
        let invite = try XCTUnwrap(PairingInvite.parse(XCTUnwrap(URL(string: "https://c-7f3a9c.danibot.com/pair#code=abcd-efgh-jklm"))))
        XCTAssertEqual(invite.credential, "ABCDEFGHJKLM")
        XCTAssertEqual(invite.connection.activeEndpoint?.kind, .hosted)
        XCTAssertEqual(invite.connection.activeEndpoint?.url, "https://c-7f3a9c.danibot.com")
        XCTAssertEqual(invite.connection.host, "c-7f3a9c.danibot.com")
    ...
    func testOnlyAWellFormedServerLinkIsAccepted() throws {
        ...
        XCTAssertNotNil(PairingInvite.parse(try XCTUnwrap(URL(string: "danibot://pair?address=192.168.1.9:8810&code=123456"))))
    }
    ...
    func testPairingPostsTheCodeWithoutACookieAndKeepsTheBearer() async throws {
        ...
        let connection = try XCTUnwrap(Connection.parse("https://c-7f3a9c.danibot.com"))
        ...
        XCTAssertEqual(request.url?.absoluteString, "https://c-7f3a9c.danibot.com/api/auth/pair")
    ...
    func testTheDescriptorIsReadableWithoutASession() async throws {
        ...
        XCTAssertEqual(ServerRequestStub.captured().first?.url?.path, "/.well-known/danibot/environment")
    }
    ...
    func testOnlyAnAdminScopedServerSessionMayAdminister() throws {
        ...
        var chatOnly = try XCTUnwrap(Connection.parse("https://c-7f3a9c.danibot.com"))
        ...
        let earlier = Data(#"{"id":"s1","name":"cab mini","host":"c-7f3a9c.danibot.com","port":443,"serverEnvironmentId":"env_7f3a9c"}"#.utf8)
    ...
    func testAServerConnectionsStreamCarriesTheBearerAndResumesFromTheCursor() async throws {
        ...
        var connection = try XCTUnwrap(Connection.parse("https://c-7f3a9c.danibot.com"))
        ...
        XCTAssertEqual(components.host, "c-7f3a9c.danibot.com")
