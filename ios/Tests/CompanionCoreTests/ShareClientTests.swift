...
final class ShareClientTests: XCTestCase {
    ...
    func testRawImageUploadKeepsBytesOutOfJSONAndReturnsMacPath() async throws {
        ...
        ShareRequestStub.responseBody = Data(#"{"path":"/Users/test/.danibot/attachments/image.png","mime":"image/png","bytes":4}"#.utf8)
        ...
        XCTAssertEqual(path, "/Users/test/.danibot/attachments/image.png")
    ...
    func testRawFileUploadEncodesDisplayNameAndReturnsMacPath() async throws {
        ShareRequestStub.statusCode = 201
        ShareRequestStub.responseBody = Data(#"{"path":"/Users/test/.danibot/files/id.pdf","name":"Q3 plan.pdf","mime":"application/pdf","bytes":3}"#.utf8)
        ...
        XCTAssertEqual(uploaded.path, "/Users/test/.danibot/files/id.pdf")
    ...
    func testFileUploadRejectsAnUnsafeReturnedDisplayName() async {
        ShareRequestStub.statusCode = 201
        ShareRequestStub.responseBody = Data(
            #"{"path":"/Users/test/.danibot/attachments/id.pdf","name":"../secret.pdf","mime":"application/pdf","bytes":3}"#.utf8
        )
