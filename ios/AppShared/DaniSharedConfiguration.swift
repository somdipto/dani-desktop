...
enum DaniSharedConfiguration {
    static let appGroupIdentifier = "group.com.danibot.shared"
    static let legacyAppBundleIdentifier = "com.danibot.app"
    static let keychainAccessGroupInfoKey = "DaniKeychainAccessGroup"
