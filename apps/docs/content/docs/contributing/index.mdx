...
Dani Bot welcomes focused fixes and features. Read the repository's [CONTRIBUTING.md](https://github.com/somdipto/dani-desktop/blob/main/CONTRIBUTING.md) before opening a pull request.
