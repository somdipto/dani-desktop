...
Developers can set `OMB_DATA_DIR` to run against a clea Dani Bot data directory. This is useful for reproduction and screenshots without touching a real workspace.
