...
```bash
sudo apt-get install -y '/home/you/.cache/danibot-updater/pending/Dani Bot-<version>-amd64.deb'
```
...
```bash
sudo apt-get install -y ~/.cache/danibot-updater/pending/Dani Bot-*-amd64.deb
```
