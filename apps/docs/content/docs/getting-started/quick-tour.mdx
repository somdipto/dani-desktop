---
title: Quick tour
description: Learn the six parts of Dani Bot before handing your first job to an agent.
icon: Map
---
...
<ProductScreenshot name="docs-model-picker" alt="Dani Bot model picker showing cloud and local agent engines" caption="Models are selected per bot, so a team can mix engines without changing global settings." />
