...
Create a second Vercel project beside the existing `danibot.com` project:
...
5. Add `docs.danibot.com` under **Settings → Domains**.
...
preview URLs for documentation pull requests. Keep `danibot.com` on the
