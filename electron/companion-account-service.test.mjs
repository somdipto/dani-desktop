...
const ENDPOINT = "https://c-opaque.danibot.com";
...
describe("Companion account service", () => {
  it("uses the packaged hosted default and only explicit safe development origins", () => {
    ...
    expect(resolveCompanionControlPlaneURL({
      isPackaged: true,
      environment: { OMB_CONTROL_PLANE_URL: "http://accounts.danibot.com" },
    })).toBe("");
    expect(resolveCompanionControlPlaneURL({
      isPackaged: true,
      environment: { OMB_CONTROL_PLANE_URL: new String("https://accounts.danibot.com") },
    })).toBe("");
