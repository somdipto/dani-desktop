# Dani Bot harness implementation plan
...
(pi, agent-orchestrator, deepseek-harness) and asking what Dani Bot lacked by
...
**The reframe that reorders everything.** Dani Bot is itself a harness. The
