...
0.1.46 point to `somdipto/dani-desktop`; newer builds point to
`somdipto/dani-desktop`. For that reason:
...
Set these in **Dani Bot → Settings → Secrets and variables → Actions**.
