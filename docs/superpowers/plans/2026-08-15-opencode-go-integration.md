...
**Goal:** Add OpenCode Go as an optional ACP-backed Dani Bot engine with dynamic models, write-only credentials, setup UX, and comprehensive tests.
...
- [ ] Add cross-platform setup commands, docs URL, and a login note that never asks Dani Bot to edit OpenCode auth files.
