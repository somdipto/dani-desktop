...
The iOS app is a thin, native client for the Dani Bot instance running on
...
The Mac must be running Dani Bot and must not be asleep. Desktop
...
to reach. Dani Bot then places the computer's MagicDNS name in that
...
The Dani Bot control plane stores account and installation metadata plus
...
The Mac must remain awake with Dani Bot running for chats, approvals, and
