...
//   dweb_repo_status     → the Dani Bot repo the daemon is tracking
...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      "Report the state of the Dani Bot repository the dweb daemon is tracking: repo name, checked-out branch, last commit, file count, and checkout path.",
    inputSchema: { type: "object", properties: {} },
  },
  {
