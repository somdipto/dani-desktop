package com.danibot.companion.notifications

import android.content.Intent
import android.net.Uri
import com.danibot.companion.MainActivity
...
object NotificationIntents {
    const val ACTION_OPEN = "com.danibot.companion.OPEN_NOTIFICATION"
    ...
    fun contentIdentity(botId: String, threadId: String): String =
        "danibot://notification/${encode(botId)}/${encode(threadId)}"
