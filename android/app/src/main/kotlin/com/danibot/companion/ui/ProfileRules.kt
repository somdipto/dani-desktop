...
import com.danibot.companion.core.VoiceProvider
...
object ProfileRules {
    ...
    private const val GENERATE_BLOCKED_FOOTER: String =
        "To generate images, configure the shared image provider in Dani Bot on your " +
    ...
    private const val SYSTEM_VOICE_UNCONFIGURED_FOOTER: String =
        "Your computer's built-in voices need no key, and it reports none it can use. Switch " +
            "the voice engine in Dani Bot on the computer to turn speech back on."
