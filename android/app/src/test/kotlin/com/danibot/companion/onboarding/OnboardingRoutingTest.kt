...
import com.danibot.companion.core.NotificationAuthorizationState
import com.danibot.companion.core.OnboardingPairingState
...
import com.danibot.companion.ui.notificationAuthorization
import com.danibot.companion.ui.onboardingPairingState
import com.danibot.companion.ui.OnboardingCopy
...
class OnboardingRoutingTest {
    ...
    fun `a deep link opens pairing even on a first launch nobody has answered`() {
        ...
        scene.session.receivePairingURL(
            "danibot://pair?address=127.0.0.1:8810&code=123456",
        )
        compose.waitForIdle()
