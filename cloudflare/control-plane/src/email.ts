...
const SUBJECTS = {
  "sign-in": "Your Dani Bot sign-in code",
  "email-verification": "Verify your Dani Bot email",
  "forget-password": "Reset your Dani Bot password",
  "change-email": "Confirm your Dani Bot email change",
